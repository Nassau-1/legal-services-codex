...
> Source: `plugins/vertical-plugins/product-legal/skills/launch-review/references/seven-category-framework.md`.
...
regimes, and the company's own calibration in `the installed practice profile for product-legal`. Research the

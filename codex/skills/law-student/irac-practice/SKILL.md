...
> Source: `plugins/vertical-plugins/law-student/skills/irac-practice/SKILL.md`.
...
1. Load `the installed practice profile for law-student` → classes, exam formats, outline locations, learning style.
...
- `the installed practice profile for law-student` → current classes, exam formats, outline locations, learning style

...
> Source: `plugins/vertical-plugins/law-student/skills/flashcards/SKILL.md`.
...
1. Load `the installed practice profile for law-student` → current classes, weak subjects, outline locations.
...
- `the installed practice profile for law-student` → current classes, weak subjects, existing outlines

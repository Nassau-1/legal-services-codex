...
> Source: `plugins/vertical-plugins/law-student/skills/session/SKILL.md`.
...
2. Load `the installed practice profile for law-student` → jurisdiction, exam format, weak subjects.

...
> Source: `plugins/vertical-plugins/litigation-legal/skills/claim-chart/SKILL.md`.
...
1. Load `the installed practice profile for litigation-legal` → role, work-product header, decision posture, document storage.
...
- `the installed practice profile for litigation-legal` → role, work-product header, decision posture, document storage, case-theory scaffolding
...
Prepend the work-product header from `the installed practice profile for litigation-legal` `## Outputs`.

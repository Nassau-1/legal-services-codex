...
> Source: `plugins/vertical-plugins/ai-governance-legal/skills/reg-gap-analysis/SKILL.md`.
...
1. Read `the installed practice profile for ai-governance-legal`. Confirm regulatory footprint and use case registry are populated.
...
4. Extract requirements. Diff against current state in `the installed practice profile for ai-governance-legal`.
...
(per `the installed practice profile for ai-governance-legal` — use case registry, vendor positions, impact assessment practices,
...
**We currently:** [what `the installed practice profile for ai-governance-legal` / AI policy / use case registry / assessment
practice shows]

...
> Source: `plugins/vertical-plugins/corporate-legal/skills/tabular-review/SKILL.md`.
...
1. Load `the installed practice profile for corporate-legal` → diligence structure, thresholds, house format.
...
- `the installed practice profile for corporate-legal` → diligence structure, materiality thresholds, house format preferences

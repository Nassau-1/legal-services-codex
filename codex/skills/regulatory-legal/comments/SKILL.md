...
> Source: `plugins/vertical-plugins/regulatory-legal/skills/comments/SKILL.md`.
...
`the installed practice profile for regulatory-legal` → default comment decision owner.

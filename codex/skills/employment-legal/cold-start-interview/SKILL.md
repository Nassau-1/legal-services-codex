...
> Source: `plugins/vertical-plugins/employment-legal/skills/cold-start-interview/SKILL.md`.
...
6. Write `the installed practice profile for employment-legal`, creating parent directories as needed.
...
Read `the installed practice profile for employment-legal`:
...
> "Done. Your configuration is at `the installed practice profile for employment-legal` — a plain text file you can read and edit directly. Anything you answered can be changed:
>

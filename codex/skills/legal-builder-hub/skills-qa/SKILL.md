...
> Source: `plugins/vertical-plugins/legal-builder-hub/skills/skills-qa/SKILL.md`.
...
- `the installed practice profile for legal-builder-hub` → practice profile and installed skills list (provides context

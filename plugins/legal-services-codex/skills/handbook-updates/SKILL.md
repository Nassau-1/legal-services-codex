...
> Source: `plugins/vertical-plugins/employment-legal/skills/handbook-updates/SKILL.md`.
...
`the installed practice profile for employment-legal` → handbook location, state supplements list, update cadence.
...
For each state supplement in `the installed practice profile for employment-legal`:

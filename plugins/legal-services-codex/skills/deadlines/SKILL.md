...
> Source: `plugins/vertical-plugins/legal-clinic/skills/deadlines/SKILL.md`.
> This is a first-pass Codex export. Review `codex/compatibility-report.md` before relying on legacy runtime instructions.

# /deadlines

1. Load `the installed practice profile for legal-clinic` → jurisdiction, practice areas, warning-day cadence.
...
- `the installed practice profile for legal-clinic` → jurisdiction, practice areas, deadline warning days (default 14/7/3/1), supervising attorneys
...
Per `the installed practice profile for legal-clinic` deadline warning days. Default 14, 7, 3, 1.

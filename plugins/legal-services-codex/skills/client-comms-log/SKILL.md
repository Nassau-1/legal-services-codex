...
> Source: `plugins/vertical-plugins/legal-clinic/skills/client-comms-log/SKILL.md`.
...
- `the installed practice profile for legal-clinic` → not heavily read; this skill is case-scoped

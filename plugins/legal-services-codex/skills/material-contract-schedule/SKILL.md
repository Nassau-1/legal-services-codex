...
> Source: `plugins/vertical-plugins/corporate-legal/skills/material-contract-schedule/SKILL.md`.
...
- `the installed practice profile for corporate-legal` → materiality thresholds (may differ from the agreement definition — use the agreement's)

...
> Source: `plugins/vertical-plugins/law-student/skills/outline-builder/SKILL.md`.
...
1. Load `the installed practice profile for law-student` → outline preferences, existing outlines.
...
1. The student has actually uploaded or written materials the skill can cite (seed materials in `the installed practice profile for law-student` → Seed materials, or an earlier section of the outline being extended), and
...
`the installed practice profile for law-student` → outline preferences (format, depth, existing outlines location).

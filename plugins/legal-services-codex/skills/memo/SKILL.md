...
> Source: `plugins/vertical-plugins/legal-clinic/skills/memo/SKILL.md`.
> This is a first-pass Codex export. Review `codex/compatibility-report.md` before relying on legacy runtime instructions.

# /memo

1. Load `the installed practice profile for legal-clinic` → practice areas, jurisdiction.
...
`the installed practice profile for legal-clinic` → practice areas, jurisdiction, supervision style.

...
description: "Invention disclosure first-pass screen \u2014 novelty, obviousness, \xA7101 eligibility, bar dates, detectability, and strategic value. Use when an invention disclosure comes in and needs triage on whether to pursue a prior-art search and patent counsel review, investigate further, or decline."
---

> Generated by `scripts/build_codex_port.py` on `2026-05-14T16:29:15.363024+02:00`.
> Source: `plugins/vertical-plugins/ip-legal/skills/invention-intake/SKILL.md`.
...
`the installed practice profile for ip-legal`.** If it is

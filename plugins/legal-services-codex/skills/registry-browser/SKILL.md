...
> Source: `plugins/vertical-plugins/legal-builder-hub/skills/registry-browser/SKILL.md`.
...
1. Load `the installed practice profile for legal-builder-hub` → watched registries.
...
`the installed practice profile for legal-builder-hub` → watched registries list.
...
2. Show what's in it
3. Add to `the installed practice profile for legal-builder-hub` → watched registries on confirmation

...
> Source: `plugins/vertical-plugins/employment-legal/skills/worker-classification/SKILL.md`.
...
Read `the installed practice profile for employment-legal` → jurisdictional footprint, any classification history or
...
If `the installed practice profile for employment-legal` records the company's house classification policy, apply it
...
Escalate per `the installed practice profile for employment-legal` if any of the following, or any team-specific
...
**Before producing a "Proceed as IC / employee / agency / vendor" final recommendation:** Read `## Who's using this` in `the installed practice profile for employment-legal`. If the Role is **Non-lawyer**:

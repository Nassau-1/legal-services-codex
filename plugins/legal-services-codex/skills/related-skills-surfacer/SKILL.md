...
> Source: `plugins/vertical-plugins/legal-builder-hub/skills/related-skills-surfacer/SKILL.md`.
...
1. Load `the installed practice profile for legal-builder-hub` → practice profile.
...
`the installed practice profile for legal-builder-hub` → practice profile, installed skills (don't suggest what's already installed).
...
Per `the installed practice profile for legal-builder-hub` → new skill notifications:

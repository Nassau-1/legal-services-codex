...
> Source: `plugins/vertical-plugins/ai-governance-legal/skills/policy-starter/SKILL.md`.
> This is a first-pass Codex export. Review `codex/compatibility-report.md` before relying on legacy runtime instructions.

# /policy-starter

1. Read `the installed practice profile for ai-governance-legal`. If the practice profile is unpopulated, stop and direct to `/ai-governance-legal:cold-start-interview`.

...
> Source: `plugins/vertical-plugins/litigation-legal/skills/matter-close/SKILL.md`.
...
**Before closing the matter (the consequential act — the matter is archived and active tracking ends):** Read `## Who's using this` in `the installed practice profile for litigation-legal`. If the Role is Non-lawyer:

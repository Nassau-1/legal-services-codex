...
> Source: `plugins/vertical-plugins/corporate-legal/skills/deal-team-summary/SKILL.md`.
...
- `the installed practice profile for corporate-legal` → Deal team briefing (cadence, format, what the business reads)
...
Per `the installed practice profile for corporate-legal` — what the business reads vs. what's for the file. Default tiers:
...
If this is a recurring brief (per `the installed practice profile for corporate-legal` cadence), lead with what changed:

...
> Source: `plugins/vertical-plugins/law-student/skills/socratic-drill/SKILL.md`.
> This is a first-pass Codex export. Review `codex/compatibility-report.md` before relying on legacy runtime instructions.

# /socratic-drill

1. Load `the installed practice profile for law-student` → learning style, classes, weak areas.
...
`the installed practice profile for law-student` → learning style (drill-me vs explain-to-me — this skill is drill-me by design, but tone adjusts), weak areas, current classes.

## The drill

### Step 1: Pick the topic

User names it, or pull from weak areas in `the installed practice profile for law-student`. If they keep avoiding a subject, that's the one to drill.
...
1. The student has actually uploaded materials (notes, outlines, case briefs, flashcards) referenced in `the installed practice profile for law-student` → Seed materials, and

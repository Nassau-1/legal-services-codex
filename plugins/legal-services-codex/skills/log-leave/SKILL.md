...
> Source: `plugins/vertical-plugins/employment-legal/skills/log-leave/SKILL.md`.
...
1. Read `the installed practice profile for employment-legal` → jurisdiction table and Systems section.
...
3. Using the jurisdiction table in `the installed practice profile for employment-legal`, look up the applicable leave

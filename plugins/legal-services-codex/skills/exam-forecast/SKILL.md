...
> Source: `plugins/vertical-plugins/law-student/skills/exam-forecast/SKILL.md`.
> This is a first-pass Codex export. Review `codex/compatibility-report.md` before relying on legacy runtime instructions.

# /exam-forecast

1. Load `the installed practice profile for law-student` → class, professor, exam format, syllabus.
...
- `the installed practice profile for law-student` → current classes, exam formats, syllabus if captured

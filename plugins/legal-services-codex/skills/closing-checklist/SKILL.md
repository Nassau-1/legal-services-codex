...
> Source: `plugins/vertical-plugins/corporate-legal/skills/closing-checklist/SKILL.md`.
...
**Before producing a "ready to close / all CPs satisfied" certification or closing memo:** Read `## Who's using this` in `the installed practice profile for corporate-legal`. If the Role is **Non-lawyer**:

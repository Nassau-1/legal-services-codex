...
7. **Install.** Copy the directory. Update `the installed practice profile for legal-builder-hub` and append to `install-log.yaml`.
...
Record in `the installed practice profile for legal-builder-hub`

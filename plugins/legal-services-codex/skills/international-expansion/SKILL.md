...
> Source: `plugins/vertical-plugins/employment-legal/skills/international-expansion/SKILL.md`.
...
Read `the installed practice profile for employment-legal` → jurisdictional footprint, escalation table, any existing
expansion notes.

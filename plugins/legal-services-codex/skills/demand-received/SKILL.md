...
> Source: `plugins/vertical-plugins/litigation-legal/skills/demand-received/SKILL.md`.
...
3. Load `the installed practice profile for litigation-legal` → risk calibration, landscape, demand-letter practice.
...
- `the installed practice profile for litigation-legal` → risk calibration (for merit assessment), landscape (is the sender a frequent adversary?), demand-letter practice (house tone and response defaults)
...
- **Leverage and pressure** — are they credibly prepared to sue? Do they have capacity? Are they a repeat-litigant adversary per `the installed practice profile for litigation-legal`?

...
> Source: `plugins/vertical-plugins/law-student/skills/legal-writing/SKILL.md`.
> This is a first-pass Codex export. Review `codex/compatibility-report.md` before relying on legacy runtime instructions.

# /legal-writing

1. Load `the installed practice profile for law-student` → class, writing skill level, past feedback patterns.
...
- `the installed practice profile for law-student` → class, assignment type (if known), writing skill level, graded-essay feedback history

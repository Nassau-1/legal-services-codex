...
> Source: `plugins/vertical-plugins/law-student/skills/cold-call-prep/SKILL.md`.
> This is a first-pass Codex export. Review `codex/compatibility-report.md` before relying on legacy runtime instructions.

# /cold-call-prep

1. Load `the installed practice profile for law-student` → class list, professors, learning style.
...
- `the installed practice profile for law-student` → current classes, professors, learning style

...
> Source: `plugins/vertical-plugins/commercial-legal/skills/review-proposals/SKILL.md`.
...
Steps through pending playbook update proposals from the monitor agent and applies approved changes to `the installed practice profile for commercial-legal`.
...
4. **For Accept or Edit:** show the exact diff to `the installed practice profile for commercial-legal` before writing. Only apply after the attorney explicitly confirms.

5. **For Reject or Defer:** log the decision. Do not modify `the installed practice profile for commercial-legal`.

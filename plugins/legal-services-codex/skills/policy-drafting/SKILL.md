...
> Source: `plugins/vertical-plugins/employment-legal/skills/policy-drafting/SKILL.md`.
> This is a first-pass Codex export. Review `codex/compatibility-report.md` before relying on legacy runtime instructions.

# /policy-drafting

1. Load `the installed practice profile for employment-legal` → jurisdictional footprint, handbook location.
...
`the installed practice profile for employment-legal` → jurisdictional footprint, handbook location and format.

...
> Source: `plugins/vertical-plugins/litigation-legal/skills/matter-briefing/SKILL.md`.
> This is a first-pass Codex export. Review `codex/compatibility-report.md` before relying on legacy runtime instructions.

# /matter-briefing

1. Load `the installed practice profile for litigation-legal` → risk calibration + relevant stakeholders.
...
- `the installed practice profile for litigation-legal` — risk calibration (so "risk: high" means something specific, not generic)
